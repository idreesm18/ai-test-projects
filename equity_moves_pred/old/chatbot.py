...
import pandas as pd
import json
from equity_moves_pred.prompts.prompts import ANALYST_ROLES, YFINANCE_DOCS_SUMMARY
...
def log_conversation(user_msg, assistant_msg, filename="output/chat_log.md"):
